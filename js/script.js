...
const eliteProjects = [
  ...
  },
  {
    ...
    number: '08',
    icon: '🌡️',
    title: 'Land Surface Temperature and Vegetation Dynamics in Owan West LGA (2014–2024)',
  ...
  {
    id: 'osun-carbon-density',
    number: '09',
    icon: '🌲',
    title: 'Forest Carbon Density Assessment in Osun State',
    category: 'Forest Monitoring • Biomass Estimation • Carbon Mapping',
    description: 'A forest-focused biomass and carbon modelling project estimating vegetation carbon density using RDVI-based methods across selected LGAs in Osun State.',
    ...
    methods: ['Landsat imagery preparation', 'Forest masking', 'RDVI/RBDI computation', 'Above-ground biomass estimation', 'Carbon density mapping'],
    ...
    tools: ['Landsat', 'RDVI', 'Carbon Modelling', 'ArcGIS Pro'],
    visualLabel: 'Carbon density and forest condition maps',
    storymap: '#', report: '#', caseStudy: '#',
    theme: 'Climate & Carbon',
    workflow: ['Prepare imagery and forest masks.', 'Compute RDVI and biomass.', 'Convert biomass to carbon.', 'Compare carbon density patterns across selected LGAs.'],
  ...
  },
  {
    ...
    number: '10',
    icon: '💧',
    title: 'Well Depth, DEM, and IDW Correlation Analysis',
    category: 'Spatial Statistics • Correlation • Interpolation',
    description: 'A geospatial-statistical project comparing interpolated and DEM-derived elevation surfaces to interpret groundwater-related spatial patterns.',
    objective: 'To evaluate the statistical relationship between well depth, interpolated elevation, and DEM-derived elevation for groundwater interpretation.',
    ...
    visualLabel: 'Correlation plots and interpolation surfaces',
    storymap: '#', report: '#', caseStudy: '#',
